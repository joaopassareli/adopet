    ...
    <div class="container">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                          <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{ route('pets.index') }}">Pets</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{ route('tutors.index') }}">Tutores</a>
                          </li>
                        </ul>
                    </div>
                </div>
        ...
        <footer>
            <p class="rodape">
                ...
                Sistema desenvolvido para uso gratuito por abrigos para adoção de pets.
            </p>
        </footer>
    </div>
